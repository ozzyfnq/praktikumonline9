...
class FirstFragment : Fragment() {
    ...
    override fun onViewCreated(view: View,
        ...
        val nameEditCity =  view.findViewById<TextInputEditText>(R.id.textInputTextCity)
        nameEditCity.addTextChangedListener(
            object : TextWatcher {
                override fun beforeTextChanged(
                    charSequence: CharSequence, i: Int, i1: Int, i2: Int) {
                }
                override fun onTextChanged(charSequence: CharSequence,
                                           i: Int, i1: Int, i2: Int) {
                    communicationViewModel!!.setCity(charSequence.toString())
                }
                override fun afterTextChanged(editable: Editable) {
                }
            })
